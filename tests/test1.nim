...
keywords: ["one", "two", "three", "four", 1, 2, 3, 4, true, false]
  """
  let inlineArrayExampleJSON = """{"keywords":["one","two","three","four",1,2,3,4,true,false]}"""
  check $yaml(inlineArrayExample) == inlineArrayExampleJSON